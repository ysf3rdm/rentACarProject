...
namespace Application.Features.Brands.Queries.GetListBrand
{
    public class GetListBrandQuery: IRequest<BrandListModel>
    {
        ...
        public class GetListBrandQueryHandler : IRequestHandler<GetListBrandQuery, BrandListModel>
        {
            ...
            public GetListBrandQueryHandler(IBrandRepository brandRepositoy, IMapper mapper)
            {
            ...
            {
               IPaginate<Brand> brands = await _brandRepositoy.GetListAsync(index: request.PageRequest.Page, size: request.PageRequest.PageSize);
